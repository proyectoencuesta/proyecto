...
<div class="form-group">
  ...
  <label> Nombre Cuestionario </label>
    <textarea class="form-control" id="exampleFormControlTextarea1" rows="4" name="nombre_cuestionario" placeholder="Ingresa el nombre del cuestionario ...." required></textarea>
  </div>
